 ...
 * \endcode
 * @details This API checks whether the self test functionality of the accel
 ...
 * \page bmi08xa_api_bmi08xa_configure_data_synchronization
 * bmi08xa_configure_data_synchronization \code int8_t
 * bmi08xa_configure_data_synchronization(struct bmi08_data_sync_cfg sync_cfg,
